...
public class IDTokenValidator{
     ...
     */
    public IDToken validate(String tokenString, String expectedClient) {
        IDToken token;

        // 1. Signature + parsing
        try {
            token = verifyAndDecodeIDToken(tokenString);
    ...
    private IDToken verifyAndDecodeIDToken(String tokenString) {
        final JWSInput jws;
        try {
        ...
        try {
            IDToken partial = jws.readJsonContent(IDToken.class);
        ...
        if (algRaw.startsWith("HS")) {
            ...
            try {
                ...
                return jws.readJsonContent(IDToken.class);
        ...
        try {
            TokenVerifier<IDToken> verifier =
                    TokenVerifier.create(tokenString, IDToken.class)
                            .publicKey(publicKey);
            ...
            IDToken verified = verifier.getToken();
